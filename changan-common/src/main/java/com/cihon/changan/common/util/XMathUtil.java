...
public class XMathUtil {
	 ...
	 * @param value     当前值
	 */
	public static double chainRelativeRatio(Double lastValue, Double value) {
	 ...
	 * @param value     当前值
	 */
	public static double chainRelativeRatio(BigDecimal lastValue, BigDecimal value) {
		if (lastValue == null || lastValue.doubleValue() < 0) {
			lastValue = new BigDecimal(0);
		}
		if (value == null || value.doubleValue() < 0) {
			value = new BigDecimal(0);
		}
		return chainRelativeRatio(lastValue.doubleValue(), value.doubleValue());
	}

	public static double chainRelativeRatio(Integer lastValue, Integer value) {
		if (lastValue == null || lastValue < 0) {
			lastValue = 0;
		}
		if (value == null || value < 0) {
		...
		return chainRelativeRatio(lastValue + 0.0, value.doubleValue() + 0.0);
	}

	public static void main(String[] args) {
		System.out.println(chainRelativeRatio(1, null));
	}
}
