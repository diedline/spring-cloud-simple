#!/bin/sh
#add by zouyutang on 20180903

#应用名称
APP_NAME=changan-gateway

#需要启动的Java主程序（main方法类）
APP_MAINCLASS=changan-gateway.jar
...
nohup $JAVA_HOME/bin/java $JAVA_OPTS -jar $APP_MAINCLASS >./$APP_NAME.log &
